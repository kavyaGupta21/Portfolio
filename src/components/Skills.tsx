import { Code, Layers, Database, Wrench, Users, BookOpen } from 'lucide-react';
...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      icon: Layers,
      skills: ['React.js', 'Next.js', 'Node.js', 'Express.js', 'TailwindCSS', 'Mongoose'],
    },
    {
    ...
    },
    {
      title: 'Soft Skills',
      icon: Users,
      skills: ['Communication', 'Teamwork', 'Time Management', 'Quick Learning', 'Adaptability', 'Creative'],
    },
    {
